                ...
                <div className="container-fluid m-2">
                    ...
                    <div className="card shadow">
                        <div className="card-header py-3">
                            <p className="text-primary m-0 font-weight-bold">Employees Info</p>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="text-md-right dataTables_filter" id="dataTable_filter"><label>
                                        <Button className={"mr-sm-2"}>Add new Employee</Button>
                            ...
                            <div className="row">
                                <div className="col-md-6 align-self-center">
                                    <p id="dataTable_info" className="dataTables_info" role="status"
                                       aria-live="polite">Showing {this.state.employees.length} to 20 of {this.state.employees.length}</p>
                                </div>
                                <div className="col-md-6">
                                    <nav
